...
if (window.location.pathname === "/index.html") {
	...
	router = new Router("content", Layout, "/index.html", [new NewTab()]);
} else if (window.location.pathname === "/options.html") {
	router = new Router("content", Layout, "/options.html", [new Options()]);
} else if (window.location.pathname === "/widgets.html") {
	router = new Router("content", Layout, "/widgets.html", [new Widgets()]);
}

const _modules = import.meta.glob("./ui/widgets/*.widget.ts", { eager: true });
export { router };
